...
namespace UnitySimpleLiquid
{
    ...
    public class LiquidContainer : MonoBehaviour
    {
        ...
        //after cup move out of the range of bottle, water level becomes ;fill amount percent;
        [Range(0f, 1f)]                 
        [SerializeField]
        private float fillAmountPercent = 0.3f;
        ...
        #region Liquid Amount                                   //glass will fill upto here..
        ...
        {
            Debug.Log(fillAmountPercent + "fill amount percent value: ");
        ...
        private void Update()
        {
            ...
            UpdateSurfacePos();
            Debug.Log(liquidRender.gameObject.transform.localScale);
